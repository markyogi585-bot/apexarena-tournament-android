...
# If gradle-wrapper.jar is missing, invoke gradle directly if available
if [ ! -f "$CLASSPATH" ]; then
...
exec "$JAVACMD" "-Dorg.gradle.appname=$APP_BASE_NAME" -classpath "$CLASSPATH" $GRADLE_WRAPPER_MAIN "$@"
